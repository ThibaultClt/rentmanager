                        ...
                        <form class="form-horizontal" method="post" action="/rentmanager/users/edit">
                            <div class="box-body">
                                <div class="form-group">
                                     <div class="col-sm-10">
                                          <input type="hidden" class="form-control" id="id" name="id" placeholder="Identifiant" value=${client.id}>
                                     </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                         <input type="date" class="form-control" id="naissance" name="naissance" placeholder="Date de naissance" value=${client.naissance}>
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
